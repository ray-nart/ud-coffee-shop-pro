...
from src.settings import AUTH0_DOMAIN, ALGORITHMS, API_AUDIENCE
...
def check_permissions(permission, payload):
    # checks for permission in payload
    ...
    # checks if user has the said permission
...
def verify_decode_jwt(token):
    # code to decode jwt token and payload
...
def requires_auth(permission=''):
    # creates a decorator to require
    # authorization of user for an endpoint
